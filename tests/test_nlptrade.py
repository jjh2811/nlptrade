...
@pytest.mark.parametrize("input_text, expected_command", [
    ...
    ("BTC 1개를 +10%에 매도", TradeCommand(intent='sell', coin='BTC', amount=1.0, price=50000*1.1, order_type='limit')),
    ("BTC 1개를 -10%에 매수", TradeCommand(intent='buy', coin='BTC', amount=1.0, price=49999*0.9, order_type='limit')),
])
